      ...
      <div className="flex items-center gap-6">
        ...
        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-primary-container">
          <img
            ...
            alt="User profile"
            src={user?.avatar || "https://lh3.googleusercontent.com/aida-public/AB6AXuAfWLIzLztXP7A-UNhveckXnMIDbfwEH3E_0I35BPE8kZWYgRqyf0A6jJmN6m4JrOXv1yaGFIOG0rjkYhayIIjMN21IY4ZBwS82ACBJzAL7SW1naI1eInPGIMq5S2VckGpheFmvYrUHYAjDOsHF7U5f5lqm3QrIc53zFk1JeZyZmuNTkkS6wXB2Msw2Efk3A3oPMaAN6u4bDu1TNPZw5xH-S7Cew00NSI1dOYLXkJLmyoPbpl9R-CUXba01rYSAP85255fmziP86M4d"}
          />
        </div>
      </div>
    </header>
