...
const StatsSidebar = ({ isVisible }) => {
  ...
  return (
    <aside className={`fixed right-0 top-16 bottom-0 w-80 bg-white border-l border-outline-variant/30 p-6 z-[30] overflow-y-auto hide-scrollbar transition-all duration-300 ease-in-out hidden lg:block ${isVisible ? 'translate-x-0' : 'translate-x-full'}`}>
